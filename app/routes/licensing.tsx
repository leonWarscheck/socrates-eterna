  ...
  return (
    <main className=" text-justify    pb-6 mt-20 ">
      <div className="max-w-4xl w-full mx-auto flex flex-col grow pt-8 px-4 ">
        <h2 className="font-bold text-center text-3xl underlin mb- mt-4 ">
        ...
        <p>
          <span className="font-bold">
            If you are a company or individual who wants to use a S.E. comic
        ...
        favorite S.E. comics to friends and followers if it is not
        ...
        S.E. comics along a theme if you plan to share them. Collecting for
        ...
        explanation is that you are free to use the S.E. comic as an example
        ...
        write an essay about how to gain wisdom and refer to a S.E. comic as
        an exhibit. That’s fair. Or perhaps a S.E. comic causes some
        ...
        Some of the older S.E. comics have outdated copyright lines that are
        ...
        for the Pantheon Community on Patreon is 216$ as of May 2024.
        <br />
        <br />
      </div>
    </main>
