...
export default function Books() {
  ...
  return (
    <>
      ...
      <main id="md-lg" className=" hidden  max-w-4x w-full mx-auto dmd:flex flex-col h-scree grow mt-16 gap-10  pb-20 min-h-dvh overflow-y-scrol bg-gradient-to-b from-purple-1000 to-purple-900">
        ...
        <div id="eterna" className=" relative flex bg-purple- 950 rounded-xl w-full h-80 shrink-0 max-w-4xl mx-auto">
          <img
            className=" h-5/6 p- mx-6 my-auto border-2 border-purple-100 "
        ...
        <div id="modern-tools" className="flex bg-purple- 950 w-full h-80 shrink-0 rounded-xl max-w-4xl mx-auto ">
          <img
            className="h-5/6 p- mx-6 my-auto border-2 "
            src="/books/tools.jpg"
            alt=""
          />
          <div className="flex flex-col m-4 pr-6">
        ...
        <div id="plato" className="flex bg-purple- 950 w-full h-80 shrink-0 rounded-xl max-w-4xl mx-auto">
          <img
            className="h-5/6 p- mx-6 my-auto border-2 border-purple-100"
        ...
        <div id="reason" className="flex bg-purple- 950 w-full h-80 shrink-0 rounded-xl max-w-4xl mx-auto">
          <img
            className="h-5/6 p- mx-6 my-auto border-2 border-purple-100"
