  ...
  return (
    <div className={`fixed   w-full bg-purple-950 z-30 min-h-30 pointer-events- auto ${isSearching && "animate-pulse"}`}>
      ...
      <div className=" relative flex  max-w-7xl w-full mx-auto min-h-30 bg-red -500">
        ...
        <div className="size-10 bg-transparent rounded-lg border-2 border-primary1 ml-auto mt-8 mr- 4">
          <img className="size-4 mt-2.5 mx-auto" src="/main/share3.svg" alt="" />


        </div>
        <div className="absolute flex flex-col top-44 right-0 size-96 bg-purple- 950 border-2 border-primary1 rounded-xl">
