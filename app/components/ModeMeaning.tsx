...
export default function ModeMeaning({ query, isSearching }) {
  ...
  return (
    <Form className="max-w-xl flex flex-col mx-auto w-full ">
      <input
        className="border-2 bg-purple-950 border-purple-400 focus:outline-none grow h-10 px-4 mx-4"
        type="search"
        defaultValue={query}
        name="search"
        placeholder=""
      ...
      <div className="flex mx-auto space-x-4  mt-6">
        <button
          ...
          type="submit"
          className="bg-dilred   text-sm small:text-sm hover:bg-purple-600 text-white pt-3 px-2 pb-1 "
        >
          Eterna Search 
        </button>
