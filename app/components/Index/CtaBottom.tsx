...
export default function CtaBottom() {
  return (
    <div className="flex flex-col w-full  pt-36 pb-28 px-4">
          <h3 className="text-center text-4xl font-bold font-socrates pb-2">Join the PANTHEON, now!</h3>
          <h4 className="text-center text-2xl">Special Offer: Purchase the full year membership and gain instant access to the retreat ticket store.</h4>
          <Link
            to="#join-pantheon"
