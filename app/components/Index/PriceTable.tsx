...
export default function PriceTable() {
  return (
    <div id="table" className="flex flex-col mx-auto w-full justify-center pt-28 pb-16 bg-gradient-to-b from-purple-950 via-purple-1000 to-purple-1000 ">
    <h2 className="text-4xl pb-5 font-bold text-center text-purple-200">Join the PANTHEON</h2>
    <table className="mt-8 bg-purple- 400 table-auto mx-auto max-w-7xl w-full px-4">
