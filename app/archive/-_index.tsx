    ...
    <main className="mb-16">
      ...
      <section className="">
        ...
        <div className="flex flex-col px-4 pt-16 mb- mx-auto w-full max-w-4xl grow">
          ...
          <div id="ad1 md" className=" hidden relative dmd:fle bg-neutral-200 text-whit w-full h- -mt-3  shrink-0 mb-16 border-8 border-dilred">
            <img
              className=" h-96 w-1/3 p- mx- 6 mt-14 object-cover bg-pink- -mb-6"
            ...
            <div className="flex flex-col mr-4 mt-4 pr-6 ml-8">
              {" "}
              ...
              <p className="overflow-hidden text-whit  text- justify hyphens-auto text- pretty mb-">
                Double Dilbert!

                By popular demand, the Dilbert calendar is back, and this time, it has been created entirely in America. Better yet, this edition is printed on two sides, for twice the comics!
                Whaaaaat???
                <br />
                <br />
                Front of page: Classic Dilbert comics as always.

                <br />
                Back of page: Dilbert Reborn (a “spicier” Dilbert comic).
                <br />
                <br />
          ...
          <div id="ad2 md" className=" hidden relative dmd:flex bg-neutral-100 text-whit w-full h- -mt-3  shrink-0 mb-12 border-8 border-dilred">
            ...
            <div className="flex flex-col mr-4 mt-4 pr-6 ml-">
              ...
              <span className="font-semibol uppercas">Double Dilbert!</span>  Back by popular demand, now featuring both <span className="font-semibold itali">Dilbert Classic</span> and <span className="font-semibold">Dilbert Reborn!</span>  2 comics each day, made in the USA! 
                </p> <Link
                  to="https://shopdilbert.online/product/2025-page-a-day-calendar/"
          ...
          <div id="ad1 sm" className="fle dmd: hidden flex-col bg-neutral-100 w-full shrink-0 mb-16 border-8 border-dilred -mt-2">
            <div className="relative  pt-16   mx-auto my-auto">
              <img
            ...
            <div className="flex flex-col pb-4 px-6">
              <div className="flex pb-4 text-xl ">
                ...
                <Link
                  to="https://shopdilbert.online/product/2025-page-a-day-calendar/"
                  className="font-light hover:underline bg-dilred text-white pt-1  h-9 px-4 ml-auto border- border-neutral-100 "
              ...
              <p className="overflow-hidden   text-justify hyphens-auto mb-5">
                ...
                Dilbert Reborn comics have been created more recently, often featuring provocative topics you might not want to share with your humorless coworkers. Rated PG-13, but still, it’s a dangerous world out there, so be careful.
                <br/>
                <span className="dmd:hidden"id="get-reborn"></span>
              </p>
            </div>
          </div>
