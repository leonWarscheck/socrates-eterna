...
export default function CtaBottom() {
  return (
    <div className="bg- gradient-to-b flex w-full flex-col from-purple-1000 via-purple-900 to-purple-1000 px-4 pb-24 pt-36">
      ...
      <Link
        to="#join-pantheon"
        className="font- socrates border- 2 mx-auto mt-7 animate-bg-pulse-slow rounded-lg bg-primary1 px-6 py-2 text-xl text-white hover:bg-purple-600"
      ...
      <Link
        className="font-ligh font- socrates mx-auto px-4 py-2 pt-6 text-purple-400 underline"
        to="/comics/meaning"
      >
